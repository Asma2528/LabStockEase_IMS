...
class ReagentsValidation {
    static RegisterReagents = [
        ...
        body('expiration_alert_date').isISO8601().withMessage('Expiration alert date must be a valid date'),
    ];
...
module.exports = ReagentsValidation;
