...
class ChemistryValidation {
    static RegisterChemistry = [
        ...
        body('date_added').isISO8601().withMessage('Date added must be a valid date').notEmpty().withMessage('Date added cannot be empty'),
        ...
        body('issued_quantity').isInt({ gt: 0 }).withMessage('Issued quantity must be a positive integer').notEmpty().withMessage('Issued quantity cannot be empty'),
        ...
        body('last_updated_date').isISO8601().withMessage('Last updated date must be a valid date').notEmpty().withMessage('Last updated date cannot be empty'),
        ...
        body('expiration_alert_date').optional().isISO8601().withMessage('Expiration alert date must be a valid date')
    ];
