...
import ViewItem from './display.measuring'; // Import the ViewItem component
import UpdateItem from './UpdateModel.measuring';

const MeasuringCard = ({ data, onDelete }) => {
