...
import { useUpdateMeasuringItemMutation } from '../../../provider/queries/Measuring.query';
...
const UpdateModel = ({ visible, setVisible, item }) => {
    ...
    const [updateMeasuringItem, updateMeasuringResponse] = useUpdateMeasuringItemMutation();
    ...
    const onSubmitHandler = async (values) => {
        try {
            ...
            const response = await updateMeasuringItem({
                    ...
                    <form onSubmit={handleSubmit} className="w-full">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="flex justify-end">
                            <Button
                            type="submit"
                                loading={updateMeasuringResponse.isLoading}
