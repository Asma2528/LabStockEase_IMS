...
import ViewItem from './display.glassware'; // Import the ViewItem component
import UpdateItem from './UpdateModel.glassware';

const GlasswareCard = ({ data, onDelete }) => {
